...
- Durchtrennung von Nervenfasern reduziert die corneale Sensibilität.
- Verminderte Stimulation der Tränendrüsen reduziert Tränenproduktion.
- Veränderung der Hornhautoberfläche beeinträchtigt Tränenfilmintegrität.
- Entzündliche Prozesse verschärfen die Symptome.
...
Die richtige Patientenauswahl ist entscheidend für den Erfolg und die Vermeidung von Komplikationen.
...
Neben den physischen Effekten spielen psychologische Faktoren eine wichtige Rolle bei der Wahrnehmung des Operationserfolgs und der Nebenwirkungen.
...
Aufgrund der Komplexität und Risiken der Augenlaser-Chirurgie sind folgende Punkte für Patienten essenziell:

- **Mehrere unabhängige Meinungen einholen:** Mindestens zwei Augenärzte sollten die Eignung prüfen, idealerweise einer ohne kommerzielle Interessen.
- **Umfassende Voruntersuchungen bestehen:** Hornhauttopographie, Pachymetrie, Pupillenmessung und Tränenfilmanalyse sind Pflicht.
- **Realistische Erwartungen entwickeln:** Brillenfreiheit ist kein garantiertes Ergebnis, und Presbyopie (Altersweitsichtigkeit) bleibt unbeeinflusst.
- **Langzeitfolgen kennen:** Auch wenn die OP kurzfristig erfolgreich ist, kann sie spätere Eingriffe erschweren oder Komplikationen verursachen.
- **Risiken verstehen:** Neben trockenen Augen und visuellen Phänomenen bestehen seltene, aber schwerwiegende Risiken.
- **Informierte Entscheidung treffen:** Nur wer vollständig aufgeklärt ist, kann eine informierte Entscheidung treffen.
